    ...
    export default {
        ...
        computed: {
            ...
            type() {
                ...
                if (this.routerName === 'statsLogStatusOperatorList' || this.routerName === 'statsLogStatusOperatorDetail') return 'online'
            ...
            btnDownloadShow() {
                if(this.routerName === 'statsLogStatusOperatorList' || this.routerName === 'statsLogStatusOperatorDetail') return
                return (
                    (this.last_days !== '') ||
