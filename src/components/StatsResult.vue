...
export default {
    ...
    data() {
        return {
            ...
            timeList: [
                {
                    name: 'Время в статусе "Онлайн"',
                    val: 'operators_time_in_online',
                    type: 'time'
                },
                {
                    name: 'Время в статусе "Перерыв"',
                    val: 'operators_time_in_break',
                    type: 'time'
                },
                {
                    name: 'Время в статусе "Обед"',
                    val: 'operators_time_in_lunch',
                    type: 'time'
                },
                {
                    name: 'Время в статусе "Оффлайн',
                    val: 'operators_time_in_offline',
                    type: 'time'
                }
            ]
        }
    ...
    computed: {
        dialogsListLeft() {
            ...
            if (this.type === 'branch') {
                list.push({
                    name: 'Процент от общего количества обращений',
                    val: 'dialogues_percents',
                    type: 'percent'
                })
            }
        ...
        dialogsListRight() {
            let list = [
                {
                    name: 'Передано диалогов в отделы',
                    val: 'dialogues_transferred_to_branches'
                },
                {
                    name: 'Передано диалогов сотрудникам',
                    val: 'dialogues_transferred_to_employees'
                },
                {
                    name: 'Средняя скорость первого ответа на диалог',
                    val: 'first_answer_average_speed',
                    type: 'time'
                }
            ]
                ...
                list.push(
                    {
                        ...
                        val: 'average_guest_time_in_queue',
                        type: 'time'
                    },
                    {
                        name: 'Максимальное время нахождения клиента в очереди',
                        val: 'maximum_guest_time_in_queue',
                        type: 'time'
                    }
                )
            }
