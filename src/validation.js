...
Validator.extend('fulsd_ru', first_uppercase_letters_spaces_dashes_RU)
Validator.extend('osbw', one_space_between_words)
Validator.extend('lsndd_ru', letters_spaces_numbers_dashes_dots_RU)
Validator.extend('df', date_format)
Validator.extend('pf', passport_format)
Validator.extend('lcnds', latin_cyrilic_numbers_dashes_spaces)
Validator.extend('intpf', international_passport_format)
Validator.extend('mlid', military_id)
Validator.extend('snils', snils)
Validator.extend('mp', mobile_phone)
Validator.extend('hm', home_phone)
Validator.extend('vd', valid_date)
Validator.extend('pdv', passport_date_valid)
Validator.extend('asc', all_same_characters)
Validator.extend('age', age)
Validator.extend('poi', place_of_issue)
Validator.extend('rs', rs)
Validator.extend('an', account_number)
Validator.extend('pif', pif_amount)
Validator.extend('pi', passport_issuer)
Validator.extend('mink', min_thousand)
Validator.extend('spass', strong_password)
Validator.extend('card', card_number)
Validator.extend('index', address_index)

Vue.use(VeeValidate, {classes: true, validity: true})
